...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, Pet, ptrType, funcType, mapType, ptrType$1, main, New;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	...
	main = function() {
		var $ptr;
		$global.pet = $externalize($makeMap($String.keyFor, [{ k: "New", v: new funcType(New) }]), mapType);
	};
	New = function(name) {
		var $ptr, name;
		return js.MakeWrapper(new Pet.ptr(name));
	};
	$pkg.New = New;
	...
	Pet.init("main", [{prop: "name", name: "name", exported: false, typ: $String, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
